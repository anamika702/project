...
<body>
<header>
    <button class="btn btn-info" id="menuToggle" style="position: fixed; z-index: 1000;">☰</button> <!-- Dodano przycisk menu -->
</header>
<div class="container-fluid">
    <div class="row">
        @if(Auth::check() && Auth::user()->stanowisko === 'kelner')
            <div class="col-md-3">
        ...
        @elseif(Auth::check() && Auth::user()->stanowisko === 'menadżer')
            <div class="col-md-3">
                <div id="sidebar" class="panel_boczny">
                    <div class="nawigacja_boczna">
                        <ul>
        ...
        @elseif(Auth::check() && Auth::user()->stanowisko === 'kucharz')
            <div class="col-md-3">
                <div id="sidebar" class="panel_boczny">
                    <div class="nawigacja_boczna">
                        <ul>
...
<a href="#" id="back-to-top">Powrót na górę</a>
<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js"></script>
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script>
